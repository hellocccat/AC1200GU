...
#if defined(RTCONFIG_NEWSSID_REV2)
#if defined(RTCONFIG_CONCURRENTREPEATER)
			sprintf((char *) ssid, "%s",  get_default_ssid(unit,band_num));
#else				
...
//		nvram_set_int("led_2g_gpio", 72|GPIO_ACTIVE_LOW);
	...
	case MODEL_RTAC53:
		...
		nvram_set("vlan2hwname", "et0");  // vlan. used to get "%smacaddr" for compare and find parent interface.
		nvram_set("lan_ifname", "br0");
 		set_basic_ifname_vars("vlan2", "vlan1", "ra0", "rai0", "NULL", "vlan1", NULL, "vlan3", 0);
	...
	case MODEL_RPAC87:	
		nvram_set("lan_ifname", "br0");
		set_basic_ifname_vars("eth2", "eth2", "ra0", "rai0", "NULL", "eth2", NULL, "NULL", 0);
...
//		nvram_set_int("led_all_gpio", 10|GPIO_ACTIVE_LOW);
	...
	case MODEL_RPAC66:	
		nvram_set("lan_ifname", "br0");
		set_basic_ifname_vars("eth0", "eth0", "ath0", "ath1", NULL, "eth0", NULL, NULL, 0);
...
#ifdef RTCONFIG_TCODE
	config_tcode(2);	/* for del rc_support */
#endif 
...
#define MKDIR(pathname,mode)		if (mkdir(pathname,mode))		perror("## mkdir " pathname)
	...
	if ((model == MODEL_RTAC1200) ||(model == MODEL_RTAC1200GA1) ||(model == MODEL_RTAC1200GU))
	{
		...
		min_free_kbytes_check = 1;	
	      ...
	      || (model == MODEL_RTAC51UP) ||(model == MODEL_RTAC53) ||(model == MODEL_RTN14U) ||(model == MODEL_RTN54U) ||(model == MODEL_RTAC54U) ||(model == MODEL_RTAC1200HP) || (model == MODEL_RTN56UB1) || (model == MODEL_RTN56UB2))
		{
...
#if defined(RTN14U) || defined(RTN65U) || defined(RTAC52U) || defined(RTAC51U) || defined(RTN11P) || defined(RTN300) || defined(RTN54U) || defined(RTCONFIG_QCA) || defined(RTAC1200HP) || defined(RTN56UB1) || defined(RTAC54U) || defined(RTN56UB2) || defined(RTAC85U)
	def_reset_wait = 50;
#endif
