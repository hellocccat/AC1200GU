...
#endif
#ifdef RPAC66	
	led_gpio_table[LED_ORANGE_POWER] = __get_gpio("led_pwr_orange_gpio");
	led_gpio_table[LED_2G_BLUE] = __get_gpio("led_2g_blue_gpio");
	led_gpio_table[LED_2G_GREEN] = __get_gpio("led_2g_green_gpio");
	led_gpio_table[LED_2G_RED] = __get_gpio("led_2g_red_gpio");
	led_gpio_table[LED_5G_BLUE] = __get_gpio("led_5g_blue_gpio");	
	led_gpio_table[LED_5G_GREEN] = __get_gpio("led_5g_green_gpio");
	led_gpio_table[LED_5G_RED] = __get_gpio("led_5g_red_gpio");
#endif
#ifdef RPAC87	
	led_gpio_table[LED_2G_GREEN1] = __get_gpio("led_2g_green_gpio1");
	led_gpio_table[LED_2G_GREEN2] = __get_gpio("led_2g_green_gpio2");
	led_gpio_table[LED_2G_GREEN3] = __get_gpio("led_2g_green_gpio3");
	led_gpio_table[LED_2G_GREEN4] = __get_gpio("led_2g_green_gpio4");

	led_gpio_table[LED_5G_GREEN1] = __get_gpio("led_5g_green_gpio1");	
	led_gpio_table[LED_5G_GREEN2] = __get_gpio("led_5g_green_gpio2");
	led_gpio_table[LED_5G_GREEN3] = __get_gpio("led_5g_green_gpio3");
	led_gpio_table[LED_5G_GREEN4] = __get_gpio("led_5g_green_gpio4");
