...
#if defined(RTN14U) || defined(RTAC51U) ||defined(RTN54U) || defined(RTAC54U) || defined(RPAC87)
/// RT-N14U mapping
enum {
	WAN_PORT=0,
	LAN1_PORT=1,
...
#elif defined(RTN56UB1) || defined(RTN56UB2) || defined(RTAC85U)
enum {
	WAN_PORT=4,
	LAN1_PORT=3,
	LAN2_PORT=2,
...
#if defined(RTAC52U) || defined(RTAC51U) || defined(RTN54U) || defined(RTAC1200HP) || defined(RTN56UB1) || defined(RTN56UB2) || defined(RTAC54U) || defined(RTAC1200GA1) || defined(RTAC1200GU) || defined(RPAC87) || defined(RTAC85U)
...
#if 0// defined(RTAC85U)
	if (!status && wan_unit >= 0)
		get_mt7621_esw_phy_linkStatus(get_wan_port_mask(wan_unit), &status);
#endif
#endif	
	return status;
