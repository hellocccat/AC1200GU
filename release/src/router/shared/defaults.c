...
#if defined(RPAC68U) || defined(RPAC66) || defined(RPAC87)
...
#endif
#endif
#if defined(RTCONFIG_QTN) || defined(RTCONFIG_MUMIMO_2G) || defined(RTCONFIG_MUMIMO_5G)
	{ "wl_mumimo", "0", 0 },
#endif
...
#endif
#if defined(RTAC85U) || defined(RPAC87) 
	{ "wl_txbf_en", "1" },	/* enable txbf by default */
#else
	{ "wl_txbf_en", "0" },
#endif	
#endif
...
#if defined (RTAC1200) || defined (RTAC1200GA1) || defined (RTAC1200GU)
	{ "apps_swap_enable", "1" },
	{ "apps_swap_size", "67000" }, // 64M
#else
	{ "apps_swap_enable", "0" },
