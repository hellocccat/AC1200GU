...
#if defined(ASUS_RTN11PB1)
	/*RT-N11P_B1 initial EPHY_LED0_N_JTDO, EPHY_LED0_N_JTDO, WLED_N  to GPIO mode*/
 	value=le32_to_cpu(*(volatile u_long *)(RALINK_SYSCTL_BASE) + 0x64);
 	value |= 0x555;  
	*(volatile u32 *)(RALINK_SYSCTL_BASE + 0x64) = cpu_to_le32(value);

	value=le32_to_cpu(*(volatile u_long *)(RALINK_PIO_BASE) + 0x04);
 	value |= 0x1000;  
	*(volatile u32 *)(RALINK_PIO_BASE + 0x04) = cpu_to_le32(value);

	value=le32_to_cpu(*(volatile u_long *)(RALINK_PIO_BASE) + 0x24);
 	value |= 0x1000;  
	*(volatile u32 *)(RALINK_PIO_BASE + 0x24) = cpu_to_le32(value);
...
#endif	 
	gpio_init();
#if !defined(ASUS_RTN14U) && !defined(ASUS_RTAC52U) && !defined(ASUS_RTAC51U) && !defined(ASUS_RTAC51UP) && !defined(ASUS_RTAC53) && !defined(ASUS_RTN11P) && !defined(ASUS_RTN54U) && !defined(ASUS_RTAC1200HP) && !defined(ASUS_RTN56UB1) && !defined(ASUS_RTAC1200GA1) && !defined(ASUS_RTAC1200GU) && !defined(ASUS_RTAC54U) && !defined(ASUS_RTAC1200) && !defined(ASUS_RPAC56) && !defined(ASUS_RTN11PB1)
	LEDOFF();
#endif
#endif	
...
#if defined(ASUS_RTN14U) || defined(ASUS_RTAC52U) || defined(ASUS_RTAC51U) || defined(ASUS_RTAC51UP) || defined(ASUS_RTAC53) || defined(ASUS_RTN11P) || defined(ASUS_RTN54U) || defined(ASUS_RTAC1200HP) || defined(ASUS_RTN56UB1) || defined(ASUS_RTAC1200GA1) || defined(ASUS_RTAC1200GU) || defined(ASUS_RTAC54U) || defined(ASUS_RTAC1200) || defined(ASUS_RPAC56) 
...
/*config bootdelay via environment parameter: bootdelay */
	...
	if (timer1 <= CONFIG_BOOTDELAY)
       ...
       mtk7620_set_gpio_pin(WIFI_2G_LED, 1);
       mtk7620_set_gpio_pin(USB_LED, 1);
#elif defined(ASUS_RTAC51UP) || defined(ASUS_RTAC53)
       mtk7620_set_gpio_pin(WIFI_2G_LED, 1);
       mtk7620_set_gpio_pin(USB_LED, 1);
       ...
       set_gpio_pin(WAN_LED, 1);
       set_gpio_pin(LAN_LED, 1);       
